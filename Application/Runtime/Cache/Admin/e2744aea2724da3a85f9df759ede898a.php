...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <script src="/i0rjph/Public/js/kindeditor/kindeditor-all.js"></script>
  <div id="page-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/i0rjph/admin.php?c=content">文章管理</a>
            </li>
            <li class="active">
...
<script>
  var SCOPE = {
    'save_url' : '/i0rjph/admin.php?c=content&a=add',
    'jump_url' : '/i0rjph/admin.php?c=content',
    'ajax_upload_image_url' : '/i0rjph/admin.php?c=image&a=ajaxuploadimage',
    'ajax_upload_swf' : '/i0rjph/Public/js/party/uploadify.swf',
  };

</script>
<!-- /#wrapper -->
<script src="/i0rjph/Public/js/admin/image.js"></script>
<script>
  // 6.2
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      uploadJson : '/i0rjph/admin.php?c=image&a=kindupload',
